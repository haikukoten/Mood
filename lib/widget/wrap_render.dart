...
class FilledWrapParentData extends ContainerBoxParentData<RenderBox> {
  int _runIndex = 0;
}

/// Displays its children in multiple horizontal or vertical runs.
///
/// A [FilledRenderWrap] lays out each child and attempts to place the child adjacent
...
/// [FilledRenderWrap] creates a new _run_ adjacent to the existing children in the
/// cross axis.
///
...
class FilledRenderWrap extends RenderBox
    with
        ContainerRenderObjectMixin<RenderBox, FilledWrapParentData>,
        RenderBoxContainerDefaultsMixin<RenderBox, FilledWrapParentData> {
  ...
  /// grouped together in the center of the overall [FilledRenderWrap] in the cross
  /// axis.
  ///
  /// Defaults to [WrapAlignment.start].
  ///
  ...
  ///
  /// If there is additional free space in the overall [FilledRenderWrap] (e.g.,
