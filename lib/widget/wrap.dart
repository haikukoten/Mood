...
import 'package:moon/widget/wrap_render.dart';

/// A widget that displays its children in multiple horizontal or vertical runs.
///
/// A [FilledWrap] lays out each child and attempts to place the child adjacent to the
/// previous child in the main axis, given by [direction], leaving [spacing]
/// space in between. If there is not enough space to fit the child, [FilledWrap]
...
/// {@tool sample}
///
/// This example renders some [Chip]s representing four contacts in a [FilledWrap] so
...
class FilledWrap extends MultiChildRenderObjectWidget {
  ...
  /// grouped together in the center of the overall [FilledWrap] in the cross axis.
  ///
  /// Defaults to [WrapAlignment.start].
  ///
  /// See also:
  ...
  ///
  /// If there is additional free space in the overall [FilledWrap] (e.g., because
  ...
  @override
  void updateRenderObject(BuildContext context, FilledRenderWrap renderObject) {
    renderObject
      ..direction = direction
      ..alignment = alignment
      ..spacing = spacing
